      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <Card>
            ...
            <CardContent>
              <a href="mailto:info@visakhamultispeciality.com" className="block text-sm font-semibold text-primary hover:underline break-all">
                info@visakhamultispeciality.com
              </a>
              <a href="mailto:appointments@visakhamultispeciality.com" className="block text-sm font-semibold text-primary hover:underline break-all">
